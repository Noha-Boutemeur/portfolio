        ...
        if (projectTitle === "Robot Rumble") {
            Swal.fire({
                html: '<p>' +
                    ...
                    'La gravité y est réaliste (voici notre constante gravitationnelle), vous êtes attiré par les planètes les plus proches et les plus massives. Vous disposez de 3 armes : <br> <br>' +
                    '<ul>' +
                        '<li>Le minigun, qui tire une rafale de balles (comportement classique d\'un minigun) </li>' +
                        '<li>Le fusil à pompe, qui tire beaucoup de balles en une seule fois (comportement classique également) </li>' +
